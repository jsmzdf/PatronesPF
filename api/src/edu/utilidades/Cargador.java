...
public class Cargador {
    ...
    private void cargarComponentesDesdeLaRutaDeUbicacion(String rutaDeUbicacion, String categoria) {
        //////////////////////////////
        if (yaHaSidoCargadaLaCategoria(categoria))
            return;// esto evita tener diversas cargadores para una misma
        //////////////////////////////
    ...
    private URL[] cargarComponentes(HashMap<String, InfoComponente> registroDeComponentes) {
        ...
        for (int i = 0; i < files.length; i++) {
            try {
                ...
                // los trim aplicados de una vez sin preguntar son los caracteristicas que como
                // minimo tiene un
